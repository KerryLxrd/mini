...
print(Fore.GREEN + '\nWARNING: Java not found or broken.' + Fore.WHITE)
zf = ZipFile('archive/java.zip', 'r')
zf.extractall('java')
print('[Downloading java]: done')
print('[Extracting java]: done')
zf.close()
print(Fore.GREEN + '\nWARNING: Game not found or broken.' + Fore.WHITE)
zf = ZipFile('archive/game.zip', 'r')
zf.extractall('game')
print('[Downloading game]: done')
